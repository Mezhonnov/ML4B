...
if selected=="Process":
    ...
    with st.expander("Modeling"):
        ...
        st.markdown("<a style='text-align: center' href='https://scikit-learn.org/stable/modules/generated/sklearn.naive_bayes.MultinomialNB.html'>Click here for more information</a>", unsafe_allow_html=True)
        ...
        st.markdown("<a style='text-align: center' href='https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.SGDClassifier.html'>Click here for more information</a>", unsafe_allow_html=True)
        ...
        st.markdown("<a style='text-align: center' href='https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LogisticRegression.html'>Click here for more information</a>", unsafe_allow_html=True)        
